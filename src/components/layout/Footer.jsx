    ...
    <footer className="bg-dark-800 text-gray-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              360° Housing Solutions. Transforming rental housing in Nigeria through technology, transparency, and trust.
            </p>
            <div className="flex space-x-3">
              <a href="#" className="w-8 h-8 bg-dark-700 hover:bg-primary rounded-lg flex items-center justify-center transition-colors">
                <Facebook size={16} />
              </a>
              <a href="#" className="w-8 h-8 bg-dark-700 hover:bg-primary rounded-lg flex items-center justify-center transition-colors">
                <Twitter size={16} />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="tel:+234XXXXXXXXXX" className="hover:text-primary transition-colors">
                  +234-XXX-XXX-XXXX
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <Mail size={16} className="flex-shrink-0 text-primary" />
                <a href="mailto:support@myrentstay.com" className="hover:text-primary transition-colors">
        ...
        <div className="border-t border-dark-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          <p>&copy; {currentYear} RentStay (Hub390). All rights reserved.</p>
